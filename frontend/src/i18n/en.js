...
const en = {
  ...
  cardSearch: {
    ...
    valueCheckBody: '{count} priced matches. Highest visible estimate: {top}. Middle priced match: {median}. Confirm variant and condition before judging value.',
    valueHelpTitle: 'Value help',
    valueHelpBody: 'Results with market data will show a quick estimate here. Prices are estimates, not guaranteed sale values.',
    results: 'results',
