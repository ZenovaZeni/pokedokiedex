...
const en = {
  ...
  fallback: {
    ...
    customImageDesc: 'Manual image used while no official card image is available',
  },
  common: {
    back: 'Back',
    loading: 'Loading...',
  ...
  auth: {
    ...
    username: 'Username',
    password: 'Password',
    chooseAvatar: 'Choose Collector Avatar',
  ...
  dashboard: {
    title: 'Dashboard',
    subtitle: 'Your card collection overview',
  ...
  cardSearch: {
    title: 'Card Search',
    subtitle: 'Find cards by name, set, or printed number',
    searchPlaceholder: 'Card name or set code + number (e.g. MEP 022)...',
    trySearch: 'Search for cards above',
    trySearchHint: 'Try "Charizard", "Pikachu", "MEP 022" or any card name',
    smartSearchTitle: 'Smart search is on',
    smartSearchHint: 'Paste a name, printed number, set code, or camera scan result. Add details like "4/102" to narrow it down.',
    valueCheck: 'Value check',
    valueCheckBody: '{count} priced matches. Highest shown value: {top}. Middle priced match: {median}. Confirm variant and condition before judging value.',
    valueHelpTitle: 'Value help',
    valueHelpBody: 'Results with market data will show a quick value check here. Final sale prices can vary by condition and variant.',
    results: 'results',
    tapForDetails: 'Tap a card to inspect it. Add only from the details screen.',
  ...
  sets: {
    ...
    noSetsFound: 'No sets found. Click Refresh to load sets.',
    refreshed: 'Sets refreshed',
  ...
  settings: {
    ...
    about: 'About',
    aboutDesc1: 'PokeDokieDex Collection Manager v1.0',
    aboutDesc2: 'Built with React and PostgreSQL',
    aboutDesc3: 'Data from',
    aboutDesc4: 'Prices shown in USD',
    saved: 'Saved',
    ...
    importButton: 'Import',
    importing: 'Running…',
    geminiApiKey: 'Photo scan key',
    geminiApiKeyDesc: 'For camera card recognition',
    ...
    app: 'App',
    dataSource: 'Card catalog',
    dataSourceDesc: 'Card information and images',
  ...
  prices: {
    ...
    cardmarketTitle: 'Market Prices (USD)',
  },
  ...
  card: {
    ...
    customImageUrlDesc: 'Used only while no official card image is available. It will be ignored once a better official image becomes available.',
  ...
  migration: {
    ...
    subtitle: 'Manual cards now available in the card catalog',
    empty: 'No catalog matches found',
    emptyHint: 'All manual cards are currently unmatched',
    apiMatchFound: 'Catalog match found',
    ...
    yourCard: 'Your Card',
    apiCard: 'Catalog card',
    matchedAt: 'Found at',
    noImage: 'No image',
    migrationInfo: 'Migration moves all entries (collection, wishlist, binders) to the catalog card and deletes the manual version.',
  },
